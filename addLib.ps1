...
$packages = @(
    ...
    @{ Name="coverlet.msbuild"; Version="6.0.4"; IncludeAssets="runtime; build; native; contentfiles; analyzers; buildtransitive"; PrivateAssets="all" },
