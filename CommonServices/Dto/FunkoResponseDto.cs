...
public record FunkoResponseDto(
    ...
    string ImagenRaw)
{
    // por si hay algo raro en la imagen
    public string Imagen => string.IsNullOrWhiteSpace(ImagenRaw)
        ? "/uploads/default.png"            // default siempre con '/'
        : (ImagenRaw.StartsWith("/") ? ImagenRaw : "/" + ImagenRaw);
};